class Achievement extends Screen {
  constructor() {
    ...
    this.images = {
      ...
      '7':  { src: 'achievements/beat_the_game_angel.png', img: null },
      '8':  { img: null },
      '9':  { img: null },
      '10': { img: null },
      '11': { img: null },
  ...
  load(image_folder, images) {
    ...
    for (let i=0; i<images.length; i++)
      this.images[str(i + 8)].img = images[i];
  ...
  mouseClicked() {
    ...
    let index = (i * this.achievements.length) + j;
  ...
  get_achievement_name(i, j) {
    const map = [
      ...
      ['Sniper', 'Kamikaze', 'Explosions', 'Laser'],
    ];
    return map[i][j];
  }
